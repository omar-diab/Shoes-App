...
const ReviewCard = ({ imgURL, customerName, rating, feedback}) => {
  return (
    <div className="flex flex-col justify-center items-center bg-white rounded-2xl p-8 shadow-2xl">
        ...
        <h3 className="mt-3 text-2xl font-palanquin font-bold text-center text-coral-red">{customerName}</h3>
    </div>
  )
}
